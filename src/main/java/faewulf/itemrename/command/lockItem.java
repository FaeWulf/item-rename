...
public class lockItem {
    ...
    static private int run(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        NbtCompound customNbt = holding.getOrCreateNbt();

        customNbt.putString("itemrename:authorUUID", player.getUuid().toString());
        customNbt.putString("itemrename:authorName", player.getName().getString());
